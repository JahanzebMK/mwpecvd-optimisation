...
#bring in MLP regressor model from scikit-learn library
nn=Pipeline(steps=[('sca', MinMaxScaler()),
                   ('mlp', MLPRegressor(random_state=70,
                                        max_iter=34000,
                                        solver = 'adam',
...
#output values predicted by model and actual values from testing data
parameters_pred = nn.predict(test_x)
print(parameters_pred)
print(test_y)



#hardness Partial dependence plots
